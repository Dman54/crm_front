...
$(window).on("load", function () {
  $(".object-room").each(function () {
    ...
    if (rightHeight > 102) {
      ...
      $(this).find(".object-room-facilities-wrapper").height("auto");
    }
  });
  ...
  function move() {
    ...
    $(".slider-wrapper ul").css({
      "-webkit-transform": "translateX(" + -(curIndex - 1) * 100 + "%",
    });
    $(".slider-wrapper ul").css({
...
$(".table-pricetypes-show-more").on("click", function () {
  ...
  $(this)
    .closest(".table-pricetypes-row")
    .find(".table-pricetypes-all")
    .toggleClass("active");
});
